...
mull = pygame.transform.scale(mull,[laius*1.3,korgus])#teeme myygimehe muutjas oleva pildifaili laiuse 1.3 korda suuremaks ja kõrguse jätame samaks
ekraan.blit(mull,[250,25])#kuvame ekraanil mull pildi faili kordinaatidega 250,25

font = pygame.font.Font(pygame.font.match_font('Comic Sans'), 35)#määrame muutujale "font" suuruseks 35 ja fondiks "Comic Sans"
tekst = font.render("Tere, olen Asko Aru", True, [255,255,0]) #määrame muutujale "tekst" väärtuseks lause mille värv on kollane
ekraan.blit(tekst, [275,100])#kuvame ekraanil teksti kordinaatidega 275,100
